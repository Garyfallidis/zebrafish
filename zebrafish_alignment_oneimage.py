...
# -*- coding: utf-8 -*-
"""
Zebrafish-alignment-withoutdipy-for only one image
"""
#Import Libraries
import numpy as np
...
def main(static_file, moving_file):
    # static_file = 'archive/template.tif'
    # moving_file = '30_uM_VPA/30 uM VPA_Image015_ch00.tif'
    # static = standardize_image(static_file)
    # static = threshold_image(imread(static_file))
    static = standardize_image(static_file)
    moving = standardize_image(moving_file)
    
    transformed, overlp = align_zebrafish2(static, moving)
    imwrite('result_transformed.png', transformed)
    imwrite('result.png', overlp)
...
if __name__ == '__main__':
    ...
    # transformed = align_zebrafish2(static, moving)
